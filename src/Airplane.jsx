...
import { updatePlaneAxis } from "./useControl";
...
export function Airplane({ handResult }) {
  console.log("🚀 ~ Airplane ~ handResult:", handResult);
  // thanks to:
  ...
  useFrame(({ camera }) => {
    updatePlaneAxis(x, y, z, planePosition, camera, handResult);
